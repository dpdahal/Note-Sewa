            ...
            <ul className="sidebar-nav" id="sidebar-nav">
                ...
                <li className="nav-item">
                    <Link className="nav-link collapsed" data-bs-target="#forms-nav" data-bs-toggle="collapse" to="#">
                        <i className="bi bi-journal-text"/><span>Books</span><i className="bi bi-chevron-down ms-auto"/>
                    </Link>
                    <ul id="forms-nav" className="nav-content collapse " data-bs-parent="#sidebar-nav">
                        ...
                        <li>
                            <Link to="/show-book">
                                <i className="bi bi-circle"/><span>Show Book</span>
                            </Link>
                        </li>
                ...
                <li className="nav-item">
                    <Link className="nav-link collapsed" data-bs-target="#forms-nav-banner" data-bs-toggle="collapse"
                          to="#">
                        <i className="bi bi-journal-text"/><span>Banners</span><i
                        className="bi bi-chevron-down ms-auto"/>
                    </Link>
                    <ul id="forms-nav-banner" className="nav-content collapse " data-bs-parent="#sidebar-nav">
                        <li>
                            <Link to="/add-banner">
                ...
                <li className="nav-item">
                    <Link className="nav-link collapsed" data-bs-target="#forms-nav-blog" data-bs-toggle="collapse"
                          to="#">
                        <i className="bi bi-journal-text"/><span>Blogs</span><i
                        className="bi bi-chevron-down ms-auto"/>
                    </Link>
                    <ul id="forms-nav-blog" className="nav-content collapse " data-bs-parent="#sidebar-nav">
                        <li>
                            <Link to="/add-blog">
